class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:user, :product, :product_type).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def bookmark_params
      params.require(:bookmark).permit(:product_id, :category_id, :user_id)
    end
end
